...
public class MMSLocator extends org.apache.axis.client.Service implements MMS {
    ...
    public MMSSoap getMMSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MMSSoap12Stub _stub = new MMSSoap12Stub(portAddress, this);
    ...
    public MMSSoap getMMSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MMSSoapStub _stub = new MMSSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MMSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                MMSSoap12Stub _stub = new MMSSoap12Stub(new java.net.URL(MMSSoap12_address), this);
                _stub.setPortName(getMMSSoap12WSDDServiceName());
                return _stub;
            }
            if (MMSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                MMSSoapStub _stub = new MMSSoapStub(new java.net.URL(MMSSoap_address), this);
                _stub.setPortName(getMMSSoapWSDDServiceName());
                return _stub;
            }
        }
